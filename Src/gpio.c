...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, Pitch_Relay_Pin|Frib_Relay_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Pitch_Relay_Pin Frib_Relay_Pin */
  GPIO_InitStruct.Pin = Pitch_Relay_Pin|Frib_Relay_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
